![](https://media.tenor.com/pHBqld5ooQsAAAAC/yes-shock.gif)

# Dojo SIMPLE MVC DEBUG

Wilders our Simple-MVC is completely buggy 😱. Your mission is to find and fix the errors that have crept into the code.
Objective: display the home page, then access the CRUD on the /items page.
Follow the instructions below to get started, and good luck! 🚀
